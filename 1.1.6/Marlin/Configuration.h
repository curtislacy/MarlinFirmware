...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75   // (mm) Diameter of the filament generally used (3.0 or 1.75mm), also used in the slicer. Used to validate sensor reading.
  ...
  #define MEASUREMENT_DELAY_CM        0.1    // (cm) The distance from the filament sensor to the melting chamber
  ...
  #define MAX_MEASUREMENT_DELAY       5    // (bytes) Buffer size for stored measurements (1 byte per cm). Must be larger than MEASUREMENT_DELAY_CM.
