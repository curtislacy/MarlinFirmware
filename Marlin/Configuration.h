...
#define STRING_CONFIG_H_AUTHOR "KaJiaB" // Who made the changes.    customized date August 3rd 2018
...
#define CUSTOM_MACHINE_NAME "Tronxy X5S M1.1.9"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 94.06 }
