...
#define STRING_CONFIG_H_AUTHOR "(Curtis Lacy, Tronxy X5S)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "X5S M2.0.x"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Stock X5S Bed Heater at 24V
  #define DEFAULT_bedKp 892.89
  #define DEFAULT_bedKi 134.56
  #define DEFAULT_bedKd 1481.19
